...
template <class T> inline void SharingPtr<T>::reset(std::nullptr_t p) {
  (void)p; // To get rid of following warnings:
  // > warning: In file included from src/lib.rs:118:
  // > warning: In file included from include/lldb/API/LLDB.h:12:
  // > warning: In file included from include/lldb/API/SBAddress.h:12:
  // > warning: In file included from include/lldb/API/SBDefines.h:13:
  // > warning: In file included from include/lldb/lldb-defines.h:12:
  // > warning: In file included from include/lldb/lldb-types.h:13:
  // > warning: In file included from include/lldb/lldb-forward.h:14:
  // > warning: include/lldb/Utility/SharingPtr.h:238:68: warning: unused parameter 'p' [-Wunused-parameter]
  // > warning: template <class T> inline void SharingPtr<T>::reset(std::nullptr_t p) {
  // > warning:                                                                    ^
